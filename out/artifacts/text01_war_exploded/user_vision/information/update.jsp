...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
        	<input type="radio" name="schoose" value="1" checked/>待定&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="schoose" value="2" checked/>就业&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="schoose" value="3"/>升学
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="sright" value="1" checked/>对口&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="sright" value="2" />不对口&nbsp;&nbsp;&nbsp;
        </td>
    </tr>
    <tr>
