...
<div class="container">
			...
			<li><a href="#testimonials_part">招聘会</a></li>
...
<div id="layerslider" style="width:100%;height:473px;">
					...
					<form action="${pageContext.request.contextPath}/User/update_us" method="post" class="definewidth m20" enctype="multipart/form-data">
